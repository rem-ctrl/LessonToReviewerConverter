...
![Application UI Screenshot](app_screenshot.png)

## Features
- **Sleek Dark Theme UI**: Built with PySide6 and customized QSS styling (#000000 dark background, #141414 panels, white typography, and custom blue-peach gradient accents).
